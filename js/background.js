...
window.AmIPeriod = false;

window.run_beep = true;
window.beep_first = false;
...
function lolresponse(response, status) {
    ...
    if (m !== null) {
        ...
        if (window.lastid < new_end) {
            ...
            if((window.run_beep) && (window.beep_first)) {
                beep();
                window.number_beeps += 1;
             } else {
                window.beep_first = true;
            }
        }
    }
...
// Function for popup. Clear BadgeText
